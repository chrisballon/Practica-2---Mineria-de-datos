---
title: 'PRA1 - Selección y preparación de un juego de datos'
...
El conjunto de datos fue elegido por su gran complejidad: 26 columnas, un amplio volumen de datos (1e6 registros), datos incompletos, también por su potencial analisis y uso de modelos de mineria de datos. 

### Planteamiento del problema

Realizar la clasificación de clientes y predecir el mejor producto para cada uno de ellos

Objetivos:

Realizar la limpieza de datos y reducción de dimensionalidad, como analisis exploratorio: al observar que se tienen muchas caracteristicas es necesario reducir las dimensiones tanto a nivel de columnas como de observaciones, el analisis exploratorio permitira seleccionar las caracteristicas que aporten información y eliminar las redundates, por ejemplo calculando el factor de correlación.

Implementar un modelo de clasificación no supervisada (clustering) y evaluar su calidad: como K-Means, DBSCAN, Optics.

Utilizando los resultados de ejemplo plantear un modelo de regresión para predecir el mejor producto para cada cliente. El dataset posee una lista de ejemplo de predicción de producto para el conjunto de datos de prueba, el metodo de regresión podría ser de tipo multivariable, ya que existen varias clases de productos.

Realizar validación cruzada con los conjuntos de entrenamiento y prueba: una vez estimada la exactitud y precisión del modelo de regresión se plantea validarlo variando los conjuntos de prueba y entrenamiento.
